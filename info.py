...
API_ID = int(environ.get('API_ID', '29817626'))
API_HASH = environ.get('API_HASH', 'c530823a3feb1ebfea88b609708384a6')
BOT_TOKEN = environ.get('BOT_TOKEN', "6876836691:AAHOOwcVO9iZ4Yw1KZxYnI545pNQLVf2ShE")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001981760264').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://f7filterdb:f7filterdb@cluster0.kxld2v2.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002062996847'))
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1001981760264'))
